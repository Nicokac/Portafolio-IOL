...
def test_render_header_shows_info_banner(monkeypatch: pytest.MonkeyPatch, _reset_header_state: _DummyStreamlit) -> None:
...
def test_render_header_switches_to_warning(monkeypatch: pytest.MonkeyPatch, _reset_header_state: _DummyStreamlit) -> None:
...
def test_render_header_hides_banner_when_missing(monkeypatch: pytest.MonkeyPatch, _reset_header_state: _DummyStreamlit) -> None:
...
def test_render_header_reuses_placeholder(monkeypatch: pytest.MonkeyPatch, _reset_header_state: _DummyStreamlit) -> None:
